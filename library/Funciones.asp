...
Function GetUserWellcome
	...
	If vHora >= 6 And vHora < 13 Then
		GetUserWellcome = GetUserWellcome & "Buen día, " & Session("NombreUsuario")
...
Select case vCodMsg
case 101
	GetAppMsg="<b>Acceso no permitido.</b><br>No tiene permisos para realizar la operación requerida."
case else
	GetAppMsg="Código de mensaje inválido."
End select
