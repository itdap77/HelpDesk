...
extArray = new Array(".jpg", ".gif",".doc");
...
<table width="100%" cellspacing="0" border="0" style="border:1px solid #C0C0C0; border-collapse: collapse; padding-left:4; padding-right:4; padding-top:1; padding-bottom:1" bordercolor="#111111" bgcolor="#A6C4E1" height="15">
<tr>
<td>
<p align="center">
<font face="Arial" style="font-size: 9pt; font-weight: 700" color="#5B5B5B">Subir Archivos</font>
</td>
</tr>
</table>
...
<br>
<B>
<FONT FACE=Arial style="font-size: 9pt">Instrucciones:</FONT><FONT FACE=Verdana Size=1><br>
</FONT>
...
<FONT FACE=Arial style="font-size: 8pt" color="#606060">1) Seleccione el archivo que corresponde al documento a ingresar.<BR>
2) El archivo debe estar en formato <b>JPG</b> , <b>GIF.</b> o <b>DOC</b>.<br>
3) El archivo no debe superar los 300 kb.<br>
4) Pulsa el botón <B>Subir Archivo</B></FONT><FONT FACE=Verdana Size=1><BR><BR>
<FONT COLOR=Red>Nota: dependiendo del tamaño de los archivos a subir, la transferencia puede tardar varios minutos.</FONT><BR><BR><BR>
</FONT>


<INPUT NAME=File1 SIZE=30 TYPE=File class=presenta><BR>
<br>
&nbsp;<INPUT TYPE=submit VALUE='Subir Archivo' class=presenta2 ><BR><BR>
...
Set f = fso.OpenTextFile(server.mappath(".") & "\upload\" & FileName, ForWriting, True) 'Directorio en donde hay que subirlo
f.Write strFileData
set f = nothing
set fso = nothing
...
End If
Response.Write "<INPUT TYPE=Button onclick='document.location=" & chr(34) & "upload2.asp" & chr(34) & "' VALUE='<< Registrar otro documento' ID='button'1 NAME='button'1 Class=presenta2>"
End Select 
%>
</td>
</tr>
