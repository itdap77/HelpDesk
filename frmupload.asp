...
<FORM ENCTYPE=multipart/form-data ACTION=FRMupload.asp?func=2 METHOD=POST ID=form1 NAME=form1>
      <p><br>
        ...
        2) El archivo debe estar en formato .JPG, .GIF, .DOC, .TXT, .ZIP, .RAR <br>
